...
import { Search, Upload, BarChart3, Settings, ArrowLeft, Shield, Clock, Database, Users, AlertTriangle, Info } from 'lucide-react';
import { Button } from '@/components/ui/button';

const validTabs = ['query', 'update', 'advanced', 'config', 'auth', 'emergency', 'info'] as const;
type ValidTab = typeof validTabs[number];

export default function OraclePageContent() {
                        ...
                        <div className="card text-center py-8">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 mt-6">
                                ...
                                <div className="p-4 bg-gray-50 rounded-lg">
                                    ...
                                    <div className="text-xs text-gray-500 mt-1">Price feeds</div>
                                </div>
                                <div className="p-4 bg-gray-50 rounded-lg">
